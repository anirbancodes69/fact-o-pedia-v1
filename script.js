...
const fact = document.querySelector(".fact-list");
...
function createFactList(data) {
  ...
  fact.insertAdjacentHTML("afterbegin", dataStr);
}
...
// console.log([1, 2, 37, 5, 35, 9].filter((el) => el < 5));
// console.log([2, 1, 37, 5, 35, 9].find((el) => el < 5));
